...
from zajecia02.liczniki_stanu import licznik_atrybut_funkcji, licznik_class, licznik_globalny, licznik
from zajecia02 import cw2 as c
...
print(licznik_atrybut_funkcji.licznik_atrybut_funkcji())  
print(licznik_atrybut_funkcji.licznik_atrybut_funkcji())
