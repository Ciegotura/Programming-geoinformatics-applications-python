...
class Ambulance:
    ...
    def update_location(self, new_location):
        ...
        logger.warning("updated location")
    ...
    def time_from_incident_happend(self, incident):
        ...
        logger.warning("incydent happend")
    ...
    def distance_from_incident(self, incident):
        ...
        logger.warning("distance from incydent")

    def ambulance_works(self):
        self.sort_incident()
        assert self.state == "thinks"
        logger.warning("ambulance works")
